...
function ResultContent() {
  ...
  // Poll: el webhook de MP puede tardar unos segundos en confirmar
  useEffect(() => {
        ...
        <Card className="w-full max-w-md">
          <CardContent className="p-8 text-center">
            <p className="text-[var(--text-muted)] mb-4">
              {isUnauthorized
                ? "Inicia sesión para ver el estado de tu reserva."
                : "No hay información de reserva."}
            </p>
            <Button asChild className="w-full">
              <Link href={isUnauthorized ? "/login" : "/services"}>
                {isUnauthorized ? "Iniciar sesión" : "Explorar servicios"}
              </Link>
            </Button>
          </CardContent>
        </Card>
  ...
  // Estado visual según el pago real
        ...
        <CardContent className="p-8 text-center">
          {isConfirmed ? (
            <>
              ...
              <p className="text-[var(--text-muted)] mb-4">
                Tu asesoría quedó reservada. Te llegará el enlace de videollamada antes de la cita.
              </p>
            ...
            <>
              ...
              <p className="text-[var(--text-muted)] mb-6">
                No se registró ningún cargo. Puedes volver a intentarlo cuando quieras.
              </p>
            ...
            <>
              ...
              <p className="text-[var(--text-muted)] mb-2">
                Mercado Pago está procesando tu pago. Esto toma unos segundos.
              </p>
              {pollAttempts >= 6 && (
                <p className="text-sm text-[var(--warning)] mb-4">
                  Sigue pendiente. Revisa tu reserva en unos minutos.
                </p>
              )}
