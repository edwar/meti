...
1. **Fork** el repositorio y clónalo:
   ```bash
   git clone https://github.com/edwar/meti.git
   cd meti
   ```
...
Distribuido bajo la [Licencia MIT](LICENSE). © 2026 [Edwar Orlando Amaya Diaz](https://github.com/edwar).

---

<div align="center">

**Meti** — *la sabiduría profesional, a un clic de distancia.* 🧠💡
